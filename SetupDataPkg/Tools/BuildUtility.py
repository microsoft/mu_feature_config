...
gtools = {
    'FV_PATCH'   : 'SetupDataPkg/Tools/PatchFv.py',
    'GEN_CFG'    : 'SetupDataPkg/Tools/GenCfgData.py',
    'FSP_SPLIT'  : 'IntelFsp2Pkg/Tools/SplitFspBin.py',
    'IMG_REPORT' : 'SetupDataPkg/Tools/GenReport.py',
    'CFG_DATA'   : 'SetupDataPkg/Tools/CfgDataTool.py'
}
...
def gen_config_file (fv_dir, brd_name, platform_id, pri_key, cfg_db_size, cfg_size, cfg_int, cfg_ext, sign_scheme, hash_type, svn):
    ...
    comm_brd_dir      = os.path.join(os.environ['SBL_SOURCE'], 'Platform', 'SetupDataPkg')
