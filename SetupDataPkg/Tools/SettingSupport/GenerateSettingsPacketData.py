# @file
#
# Script to Generate a Device Firmware Configuration Interface Settings Blob
#
...
##
## Script to Generate a Device Firmware Configuration Interface Settings Blob
## This tool takes in a XML file in SettingsPacket format, packages it in a
## DFCI_SECURED_SETTINGS_APPLY_VAR structure, signs it with the
...
## GUID: gDfciSettingsManagerVarNamespace
## NAME: DFCI_SETTINGS_APPLY_INPUT_VAR_NAME    L"DfciSettingsRequest"
##
## THIS IS FOR UNIT TEST
##
## General process:
##   Phase 1: Create payload file by combining relevant info
##   Phase 2: Sign it using signtool.exe
