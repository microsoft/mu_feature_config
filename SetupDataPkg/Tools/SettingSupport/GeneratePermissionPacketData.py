...
from Data.PermissionPacketVariable import PermissionApplyVariable   # noqa: E402
from Data.PermissionPacketVariable import PermissionResultVariable  # noqa: E402
...
def main():
    parser = argparse.ArgumentParser(
        description="Create SEM Permission Packet Variable"
    )
    ...
    parser.add_argument(
        "-p", dest="PrintFile", help="Print File as Permission Blob", default=None
    )
    parser.add_argument(
        "-pr",
        dest="PrintResultsFile",
        help="Print Result File as Permission Blob",
        default=None,
    )
    parser.add_argument(
        "-pc",
        dest="PrintCurrentFile",
        help="Print Current File to {basename}_Current.xml",
        default=None,
    )
    parser.add_argument(
        "--dirty",
    ...
    Step1Group.add_argument(
        ...
        default=PermissionApplyVariable.VERSION_V1,
    )
    Step1Group.add_argument(
        "--SMBIOSMfg",
        dest="SMBIOSMfg",
