...
def main():
    ...
    parser.add_argument("-t", "--Transition1", dest="Transition1FilePath", help="Path to Transition1 packet",
                        default=None)
    parser.add_argument("-t2", "--Transition2", dest="Transition2FilePath", help="Path to Transition2 packet",
                        default=None)
