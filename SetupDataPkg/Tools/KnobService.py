...
def generate_getter_implementation(schema, header_path, efi_type):
    with open(header_path, 'w', newline='') as out:
        ...
        out.write(get_line_ending(efi_type))
        out.write(get_spacing_string(efi_type))
        out.write("POLICY_PPI *PolPpi  = NULL;" + get_line_ending(efi_type))
        out.write(get_spacing_string(efi_type))
        ...
        out.write(get_line_ending(efi_type))
        out.write(get_spacing_string(efi_type))
        out.write("Status = PeiServicesLocatePpi (" + get_line_ending(efi_type))
        out.write(get_spacing_string(efi_type, num=6))
        out.write("&gPeiPolicyPpiGuid," + get_line_ending(efi_type))
        out.write(get_spacing_string(efi_type, num=6))
        out.write("0," + get_line_ending(efi_type))
        out.write(get_spacing_string(efi_type, num=6))
        out.write("NULL," + get_line_ending(efi_type))
        out.write(get_spacing_string(efi_type, num=6))
        out.write("(VOID **)&PolPpi" + get_line_ending(efi_type))
        out.write(get_spacing_string(efi_type, num=6))
        out.write(");" + get_line_ending(efi_type))
        out.write(get_line_ending(efi_type))
        ...
        out.write("if (EFI_ERROR (Status)) {" + get_line_ending(efi_type))
        out.write(get_spacing_string(efi_type, num=2))
        out.write('DEBUG ((DEBUG_ERROR, "%a failed to locate policy service!\\n", __FUNCTION__));')
        out.write(get_line_ending(efi_type))
        out.write(get_spacing_string(efi_type, num=2))
        out.write("ASSERT (FALSE);" + get_line_ending(efi_type))
        out.write(get_spacing_string(efi_type, num=2))
