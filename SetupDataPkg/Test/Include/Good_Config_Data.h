...
EFI_GUID mKnown_Good_Yaml_Guid = { 0x7664559F, 0x829E, 0x48E8, { 0xA4, 0x73, 0xF1, 0x2A, 0xDA, 0xD1, 0xDD, 0xD2 } };
EFI_GUID mKnown_Good_Xml_Guid  = { 0x9FD43EFE, 0x73B1, 0xED41, { 0x90, 0x76, 0x35, 0x66, 0x61, 0xD4, 0x6A, 0x42 } };
