  ...
  )
{
  ...
  //
  AddTestCase (MiscTests, "ConfApp should initialize properly", "NormalInit", ConfAppSysInfoInit, NULL, SysInfoCleanup, NULL);
  AddTestCase (MiscTests, "ConfApp select Esc should go to previous menu", "SelectEsc", ConfAppSysInfoSelectEsc, NULL, SysInfoCleanup, NULL);
  AddTestCase (MiscTests, "ConfApp Select others should do nothing", "SelectOther", ConfAppSysInfoSelectOther, NULL, SysInfoCleanup, NULL);
  AddTestCase (MiscTests, "ConfApp should auto refresh time display", "TimeRefresh", ConfAppSysInfoTimeRefresh, NULL, SysInfoCleanup, NULL);
