/** @file
SvdXmlSettingSchemaSupportLib.h
...
#ifndef __SVD_XML_SETTING_SCHEMA_SUPPORT_LIB__
#define __SVD_XML_SETTING_SCHEMA_SUPPORT_LIB__
...
#endif //__SVD_XML_SETTING_SCHEMA_SUPPORT_LIB__
