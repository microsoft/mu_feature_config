...
/**
  ...
  ConfigKnobShimDxeLib and run the ConfigKnobShimDxeLib unit test.
  ...
  )
{
  ...
  UNIT_TEST_SUITE_HANDLE      ConfigKnobShimDxeLib;
  ...
  //
  // Populate the ConfigKnobShimDxeLib Unit Test Suite.
  //
  Status = CreateUnitTestSuite (&ConfigKnobShimDxeLib, Framework, "ConfigKnobShimDxeLib Iteration Tests", "ConfigKnobShimDxeLib.Iterate", NULL, NULL);
  if (EFI_ERROR (Status)) {
    DEBUG ((DEBUG_ERROR, "Failed in CreateUnitTestSuite for ConfigKnobShimDxeLib\n"));
  ...
  // Failure Tests
  //
  AddTestCase (ConfigKnobShimDxeLib, "Null params should return null", "GetConfigKnobInvalidParamTest", GetConfigKnobInvalidParamTest, NULL, NULL, NULL);
