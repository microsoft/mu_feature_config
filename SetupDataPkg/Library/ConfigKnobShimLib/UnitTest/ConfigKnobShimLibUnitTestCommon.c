  ...
  )
{
  ...
  Status = GetConfigKnob (&ConfigKnobGuid, ConfigKnobName, (VOID *)&ConfigKnobData, ProfileDefaultSize, &ProfileDefaultValue, 0);
  UT_ASSERT_STATUS_EQUAL (Status, EFI_INVALID_PARAMETER);

  Status = GetConfigKnob (&ConfigKnobGuid, ConfigKnobName, (VOID *)&ConfigKnobData, ProfileDefaultSize, NULL, ProfileDefaultSize);
  UT_ASSERT_STATUS_EQUAL (Status, EFI_INVALID_PARAMETER);

  Status = GetConfigKnob (&ConfigKnobGuid, ConfigKnobName, (VOID *)&ConfigKnobData, 0, &ProfileDefaultValue, ProfileDefaultSize);
  UT_ASSERT_STATUS_EQUAL (Status, EFI_INVALID_PARAMETER);

  Status = GetConfigKnob (&ConfigKnobGuid, ConfigKnobName, NULL, ProfileDefaultSize, &ProfileDefaultValue, ProfileDefaultSize);
  UT_ASSERT_STATUS_EQUAL (Status, EFI_INVALID_PARAMETER);

  Status = GetConfigKnob (&ConfigKnobGuid, NULL, (VOID *)&ConfigKnobData, ProfileDefaultSize, &ProfileDefaultValue, ProfileDefaultSize);
  UT_ASSERT_STATUS_EQUAL (Status, EFI_INVALID_PARAMETER);

  Status = GetConfigKnob (NULL, ConfigKnobName, (VOID *)&ConfigKnobData, ProfileDefaultSize, &ProfileDefaultValue, ProfileDefaultSize);
  UT_ASSERT_STATUS_EQUAL (Status, EFI_INVALID_PARAMETER);

  Status = GetConfigKnob (&ConfigKnobGuid, ConfigKnobName, (VOID *)&ConfigKnobData, ProfileDefaultSize, &ProfileDefaultValue, sizeof (UINT32));
  ...
  )
{
  ...
  Status = GetConfigKnob (&ConfigKnobGuid, ConfigKnobName, (VOID *)&ConfigKnobData, ProfileDefaultSize, &ProfileDefaultValue, ProfileDefaultSize);
